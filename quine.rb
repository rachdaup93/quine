...
<html>
  ...
  <div style="width:60%;margin:20px auto;">
   <h1 style="text-align:center;">Source Code Request</h1>
  <ol>
    ...
    <li><div>
      ...
      <code>curl http://your-app.herokuapp.com/code</code>
  ...
  <div style="width:60%; margin:0 auto;" class="panel panel-warning">
    <div class="panel-heading">Source Code Loading</div>
  ...
  function requestCode(){
     $.ajax({
          ...
          $(".panel-heading").html("Source Code Loaded Successfully");
